...
# 抽奖，乙品质武将池
GET_HERO_QUALITY_TWO_POOL = [40,41,42,45,46,47,49,50,52,53,54,55,57,58,59,60,61,62,63,64,65,66,67,68,69,70,71,72,73,75, 48, 51, 74, 78,102]
#新手 48,51,74,78
# 抽奖，丙品质武将池
GET_HERO_QUALITY_THREE_POOL = [100,76,77,79,80,81,82,84,85,86,87,88,89,90,92,93,94,95,96,97,98,99,101,103]
...
# 掠夺应两计算参数
PLUNDER_GOT_GOLD_PARAM_BASE_ADJUST = 0.20

# 得战俘概率 %
PLUNDER_GET_PRISONER_PROB = 18
# 得物品按照多少分钟计算
